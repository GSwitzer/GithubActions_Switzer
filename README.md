[![Run App Switzer, Guenther](https://github.com/GSwitzer/GithubActions_Switzer/actions/workflows/run-app.yml/badge.svg)](https://github.com/GSwitzer/GithubActions_Switzer/actions/workflows/run-app.yml)
